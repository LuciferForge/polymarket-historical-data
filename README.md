...
**19.2M+ price snapshots. 19,200+ markets. 79 days of history (since 2026-03-28). 15-minute resolution.**
...
|-------|------|-------------|
| `markets` | 19,200+ | Question, category, volume_24h, liquidity, end_date |
| `prices` | 19,200,000+ | 15-min OHLC snapshots for YES/NO outcomes |
| `orderbooks` | 1,890,000+ | Bid/ask depth snapshots |
