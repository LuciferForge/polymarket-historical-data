...
**18.7M+ price snapshots. 18,700+ markets. 77 days of history (since 2026-03-28). 15-minute resolution.**
...
|-------|------|-------------|
| `markets` | 18,700+ | Question, category, volume_24h, liquidity, end_date |
| `prices` | 18,700,000+ | 15-min OHLC snapshots for YES/NO outcomes |
