...
**19.3M+ price snapshots. 19,300+ markets. 80 days of history (since 2026-03-28). 15-minute resolution.**
...
|-------|------|-------------|
| `markets` | 19,300+ | Question, category, volume_24h, liquidity, end_date |
| `prices` | 19,300,000+ | 15-min OHLC snapshots for YES/NO outcomes |
| `orderbooks` | 1,900,000+ | Bid/ask depth snapshots |
